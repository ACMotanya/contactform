...
"border:2px solid black;-moz-border-radius: 15px;border-radius: 15px;background: white;padding: 2px;position:fixed;top:100px;left:-28px;width:75px;height:20px"+
"'><a style='font-family: Helvetica, sans-serif:font-size: 14px !important;color:black;' href='#'>Contact Us</a></div>")		
